...
public class TrainExpandableRecyclerView extends RecyclerView
{


    public TrainExpandableRecyclerView(Context context)
    {
        super(context, null);
        initRecycler();
    }

    public TrainExpandableRecyclerView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initRecycler();
    }

    public TrainExpandableRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class SavedState implements Parcelable
    {
        ...
        {
            Parcelable superState = in.readParcelable(TrainExpandableRecyclerView.class.getClassLoader());
                ...
                public void onClick(View v) {
                    if (isExpanded(group)) {
                        ...
                        if(onExpandableListener != null){
                            onExpandableListener.collapse(group, (GroupViewHolder) holder);
                        }
                        /*if (holder instanceof GroupViewHolder)
                        ...
                        //expand(group);
                        if(onExpandableListener != null){
                            onExpandableListener.expand(group,(GroupViewHolder) holder);
                        }
                        /*if (holder instanceof GroupViewHolder)
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder
    {
        ...
        {
            super(View.inflate(context, R.layout.train_expandable_group, null));
    ...
    public interface OnExpandableListener {
        void collapse(int group, GroupViewHolder viewHolder);
        void expand(int group, GroupViewHolder viewHolder);
    }
