...
public class MoreTaskSetAdapter extends RecyclerView.Adapter<MoreTaskSetAdapter.EvaluationHolder> {
    ...
    public MoreTaskSetAdapter(Context context) {
    ...
    @Override
    public MoreTaskSetAdapter.EvaluationHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.task_set_item, parent, false);
