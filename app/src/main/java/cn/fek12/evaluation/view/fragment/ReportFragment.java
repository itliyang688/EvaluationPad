 ...
 */
public class ReportFragment extends BaseFragment<PresentationPresenter> implements PresentationPresenter.View {
    ...
    private void initLeftRecycler() {
        ...
        adapter = new PresentationNewsAdapter(null, PresentationNewsAdapter.PRESENTATION);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && multipleStatusView != null && PrefUtilsData.getIsReportRefresh()) {
            PrefUtilsData.setIsReportRefresh(false);
            multipleStatusView.showLoading();
            mPresenter.queryAWeek(getContext(), grade, semester, subject, textbook, MyApplication.getMyApp().getUserId(), userType);
        }
    }
