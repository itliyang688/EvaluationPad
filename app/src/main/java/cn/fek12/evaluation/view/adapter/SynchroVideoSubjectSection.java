 ...
 */
public class SynchroVideoSubjectSection extends Section {
    ...
    public SynchroVideoSubjectSection(List<SubjectEntity.DataBean> list, String checkId, OnSelectItmeListener onSelectItmeListener) {
