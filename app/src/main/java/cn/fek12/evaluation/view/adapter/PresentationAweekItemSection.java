...
public class PresentationAweekItemSection extends Section {
    ...
    public PresentationAweekItemSection(int typePage,List<AWeekEntity.DataBean.WeekAndDayBean> list,Context context,String header, PresentationAweekItemSection.OnSelectItmeListener onSelectItmeListener) {
