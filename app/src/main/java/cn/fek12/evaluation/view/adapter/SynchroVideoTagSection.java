 ...
 * @Package: cn.fek12.evaluation.view.adapter
 * @ClassName: SynchroVideoTagSection
 * @Description:
 * @CreateDate: 2020/6/25 15:04
 */
public class SynchroVideoTagSection extends Section {
    ...
    public SynchroVideoTagSection(Context context, List<TextbookChildEntity> list, String checkId, OnSelectItmeListener onSelectItmeListener) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        for(int i = 0; i < mList.size(); i++){
            View viewItem = View.inflate(mContext, R.layout.synchro_video_tag_item,null);
