 ...
 */
public class EvaluationDetailsSubjectSection extends Section {
    ...
    public EvaluationDetailsSubjectSection(List<SubjectEntity.DataBean> list, String checkId, OnSelectItmeListener onSelectItmeListener) {
