 ...
 */
public class MicroLessonTreePresenter extends BasePresenter<IMicroLessonTree.View> implements IMicroLessonTree{
    private View infoView;
    public MicroLessonTreePresenter(@NonNull View view, Context activity) {
        this.infoView = view;
    }
