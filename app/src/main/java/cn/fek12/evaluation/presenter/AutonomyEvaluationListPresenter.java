 ...
 */
public class AutonomyEvaluationListPresenter extends BasePresenter<IAutonomyEvaluationList.View> implements IAutonomyEvaluationList {
    private View infoView;
    public AutonomyEvaluationListPresenter(@NonNull View view, Context activity) {
        this.infoView = view;
    }
    ...
    public void queryPaperList(Context context, String grade, String subject, String textbook, String semester, String userId, String currentPage) {
        ApiRetrofit.getInstance().getApiService().queryAutonomyPaperList(grade,semester,subject,textbook,userId,currentPage)
                .compose(RxHelper.observableIO2Main(context))
