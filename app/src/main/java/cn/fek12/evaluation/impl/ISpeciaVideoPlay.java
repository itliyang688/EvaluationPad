...
public interface ISpeciaVideoPlay {
    void schedule(Context context, String cacheKey,String structLayKey, String playScheduleTime, String type, String videoId, String userId,int typePage,String isEnd);
